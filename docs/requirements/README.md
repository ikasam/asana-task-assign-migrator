...
>
> **2026-05-30 追加フェーズ**: `--workspace` をドメイン名でも指定できるようにする UX 改善要求を追記しました（要望 W-009 / 要求 D-018 / 要件 R24〜R25 / 仕様 S-027 / 判断 29〜30 / 制約 C-014（緩和）, C-018 / 仮説 H-API8）。
>
> **2026-05-31 追加フェーズ**: main への push を起点にリリース（tag 付与含む）を自動化する要求分析を追記しました（要望 W-010 / 要求 D-019〜D-022 / 要件 R26〜R31 / 仕様 S-028〜S-032 / 判断 31〜35 / 設計選択 12〜14 / 制約 C-019, C-020 / 仮説 H-DENO4）。
...
| [06_decisions.md](06_decisions.md) | 対話中の判断 1〜35 の履歴 |
